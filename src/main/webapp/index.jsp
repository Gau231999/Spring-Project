...
<body>
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form  action="data"  id="Login_form" class="login100-form validate-form">
					<span class="login100-form-title p-b-2">
						LOGIN
					</span>
					<div class="text-center w-full p-t-42 p-b-22">
						<span class="txt1">
							 Login with mes id only
						</span>
					</div>
	...
	<script type="text/javascript">
      ...
      function onSignIn(googleUser) {
    	  ...
    	  localStorage.setItem("googleid",profile.getEmail());
    	
    	  window.location.href = "/Login_mesvalidation?email="+profile.getEmail()+"&name="+profile.getName()+"&imgurl="+ profile.getImageUrl()+"&id="+profile.getId();
    	  }
   </script>
