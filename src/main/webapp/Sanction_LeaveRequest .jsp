    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
	    				<table class="table">
						    ...
						    <tbody>
							   <c:forEach items="${leaves}" var="value">
							       <tr class="text-center">
										...
										<td class="total">${value.type}</td>
										<td class="total"><p>${value.dateFrom}</p><p>${value.dateTo}</p></td>
										<td class="total">${value.nod}</td>
										<td ><a href="/Reject?reqid=${value.id}&reqemail=${value.email}"><i class="fa fa-close" style="font-size:30px;color:red"></i></a></td>
										<td ><a href="/Approve?reqid=${value.id}&reqemail=${value.email}"><i class="fa fa-check" style="font-size:30px;"></i></a></td>
									</tr>
								</c:forEach>
