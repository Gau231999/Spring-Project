...
import com.example.demo.controller.FileStorageException;
import com.example.demo.controller.MentionedFileNotFoundException;
import com.example.demo.entity.FileStoragePojo;

@Service
public class Service_Documents {
	...
	@Autowired
    public Service_Documents(FileStoragePojo fileStoragePojo) {
